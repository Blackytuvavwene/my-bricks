...
class {{page.pascalCase()}}LoadingPage extends ConsumerWidget {
...
class _Mobile{{page.pascalCase()}}LoadingPage extends ConsumerWidget {
...
class _Tablet{{page.pascalCase()}}LoadingPage extends ConsumerWidget {
...
class _Desktop{{page.pascalCase()}}LoadingPage extends ConsumerWidget {
