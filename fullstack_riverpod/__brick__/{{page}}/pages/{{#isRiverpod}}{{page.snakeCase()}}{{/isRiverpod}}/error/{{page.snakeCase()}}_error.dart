...
class {{page.pascalCase()}}Error extends ConsumerWidget {
...
class _{{page.pascalCase()}}ErrorMobile extends ConsumerWidget {
...
class _{{page.pascalCase()}}ErrorTablet extends ConsumerWidget {
...
class _{{page.pascalCase()}}ErrorDesktop extends ConsumerWidget {
